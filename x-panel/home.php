...
$materi = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM materi"));
?>
            ...
            <div class='row'>
                ...
                <div class="col-lg-4">
                    <div class="small-box bg-purple ">
                        <div class="inner">
                            <h3><?= $materi ?></h3>Materi Belajar
                        </div>
                        <div class="icon">
                            <i class="fa fa-envelope"></i>
                        </div>
                        <a href="?pg=materi" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="small-box bg-blue ">
                        <div class="inner">
                            <h3><?= $tugas ?></h3>Tugas Siswa
                        </div>
                        <div class="icon">
                            <i class="fa fa-envelope-open-text"></i>
                        </div>
                        <a href="?pg=tugas" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
